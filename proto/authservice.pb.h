...
enum ServerError_ErrorType : int {
  ...
  ServerError_ErrorType_USER_ALREADY_EXISTS = 1,
  ServerError_ErrorType_USER_DOES_NOT_EXIST = 2,
  ...
  ServerError_ErrorType_PASSWORD_NOT_CONFIRMED = 7,
  ServerError_ErrorType_UNEXPECTED_ERROR = 8,
...
constexpr ServerError_ErrorType ServerError_ErrorType_ErrorType_MAX = static_cast<ServerError_ErrorType>(8);
constexpr int ServerError_ErrorType_ErrorType_ARRAYSIZE = 8 + 1;
...
class ServerError final :
 ...
 public:
  ...
  static constexpr ErrorType USER_ALREADY_EXISTS = ServerError_ErrorType_USER_ALREADY_EXISTS;
  static constexpr ErrorType USER_DOES_NOT_EXIST = ServerError_ErrorType_USER_DOES_NOT_EXIST;
  ...
  static constexpr ErrorType PASSWORD_NOT_CONFIRMED = ServerError_ErrorType_PASSWORD_NOT_CONFIRMED;
...
inline const std::string& ServerError::error_message() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:authservice.ServerError.error_message)
...
inline PROTOBUF_ALWAYS_INLINE void ServerError::set_error_message(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:authservice.ServerError.error_message)
}
inline std::string* ServerError::mutable_error_message() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_error_message();
  // @@protoc_insertion_point(field_mutable:authservice.ServerError.error_message)
  return _s;
}
...
inline std::string* ServerError::release_error_message() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:authservice.ServerError.error_message)
...
inline void ServerError::set_allocated_error_message(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:authservice.ServerError.error_message)
}
...
// string password_confirmation = 4;
inline void SigninRequest::clear_password_confirmation() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.password_confirmation_.ClearToEmpty();
}
inline const std::string& SigninRequest::password_confirmation() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:authservice.SigninRequest.password_confirmation)
  return _internal_password_confirmation();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void SigninRequest::set_password_confirmation(Arg_&& arg,
                                                     Args_... args) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.password_confirmation_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:authservice.SigninRequest.password_confirmation)
}
inline std::string* SigninRequest::mutable_password_confirmation() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_password_confirmation();
  // @@protoc_insertion_point(field_mutable:authservice.SigninRequest.password_confirmation)
  return _s;
}
inline const std::string& SigninRequest::_internal_password_confirmation() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.password_confirmation_.Get();
}
inline void SigninRequest::_internal_set_password_confirmation(const std::string& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.password_confirmation_.Set(value, GetArena());
}
inline std::string* SigninRequest::_internal_mutable_password_confirmation() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  return _impl_.password_confirmation_.Mutable( GetArena());
}
inline std::string* SigninRequest::release_password_confirmation() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:authservice.SigninRequest.password_confirmation)
  return _impl_.password_confirmation_.Release();
}
inline void SigninRequest::set_allocated_password_confirmation(std::string* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:authservice.SigninRequest.password_confirmation)
}
